...
/**
 * Mobile menu toggle untuk hamburger navigation
 */
...
/**
 * Initialize mobile navigation pada page load
 */
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Setup hamburger menu button jika ada
    ...
    // Handle modal dengan .active class
...
function initializeAdminPage() {
    ...
    // Event listeners
    document.querySelector('.admin-tabs').addEventListener('click', switchAdminTab);
...
function initializeDashboard() {
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (currentUser) {
            ...
            const addBookButtonContainer = document.getElementById('addBookButtonContainer');
    
            if (currentUser.role === 'admin') {
                // Show admin-specific features
                if (adminMenu) adminMenu.style.display = 'block';
                if (addBookButtonContainer) addBookButtonContainer.style.display = 'block';
            } else {
                // Hide admin-specific features for regular users
                if (adminMenu) adminMenu.style.display = 'none';
                if (addBookButtonContainer) addBookButtonContainer.style.display = 'none';
            }
        }
    ...
    function loadDashboardArticles() {
        ...
        dashboardArticles.innerHTML = latestArticles.map(article => `
...
function openArticleDetail(index) {
    // Navigate to article page and show article detail
